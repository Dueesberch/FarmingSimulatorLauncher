...
dictionary = {
    "en": {
        ...
        "cancel": "Cancel",
        "change": "Change",
        "create_upload_folder": "Create folder with all required mods to upload eg server?",
    ...
    "de": {
        ...
        "cancel": "Abbrechen",
        "change": "Ändern",
        "create_upload_folder": "Ordner mit benötigten Mods anlegen für Upload? (zB für FTP)",
